...
void	orgedit		args(( CHAR_DATA *, char * ) );
void	cledit		args( ( CHAR_DATA *, char * ) );
...
extern const struct olc_cmd_type	orgedit_table[];
...
DECLARE_OLC_FUN( orgedit_show );
DECLARE_OLC_FUN( orgedit_name );
DECLARE_OLC_FUN( orgedit_patron );
DECLARE_OLC_FUN( orgedit_rank );
DECLARE_OLC_FUN( orgedit_skill );
DECLARE_OLC_FUN( orgedit_new );
DECLARE_OLC_FUN( orgedit_list );
DECLARE_OLC_FUN( orgedit_delete );
DECLARE_OLC_FUN( orgedit_message );
DECLARE_OLC_FUN( orgedit_type );
DECLARE_OLC_FUN( orgedit_file	);
/** Guild Editor Prototypes
  */
DECLARE_OLC_FUN( cledit_flags		);
DECLARE_OLC_FUN( cledit_rank		);
...
DECLARE_OLC_FUN( cledit_rooms            );
DECLARE_OLC_FUN( cledit_ml               );
...
#define EDIT_ORG(Ch, Org)		( Org = (ORGANIZATION *) Ch->desc->pEdit )
