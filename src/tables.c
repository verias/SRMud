...
const struct token_type token_table[MAX_TOKEN] =
{
	{"normal",	"a normal token",
	"A normal token lies here, collecting dust.",
	1,
	250, 	0, "gold", FALSE },

	{"practice",	"a practice token",
	"A practice token lies here.",
	2,
	10,		0, "practices", FALSE },
	
	{"train",		"a train token",
	"A train token is here.",
	3,
	10,		0, "trains",FALSE},

	{"quest",		"a quest token",
	"A quest token is here.",
	4,
	250,	20, "quest points", FALSE},

	{"experience", "an experience token",
	"An experience token is lying here.",
	5,
	150,    25, "experience", FALSE},
