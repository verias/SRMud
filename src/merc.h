...
#define PULSE_PER_SECOND	    7
#define PULSE_EVENT			( 2 * PULSE_PER_SECOND)
#define PULSE_VIOLENCE		  ( 3 * PULSE_PER_SECOND)
#define PULSE_MOBILE		  ( 4 * PULSE_PER_SECOND)
#define PULSE_MUSIC		  ( 6 * PULSE_PER_SECOND)
#define PULSE_TICK		  (140 * PULSE_PER_SECOND)
...
#define XC_G9    "\033[38;5;22m"
                      /*Blues*/
#define XC_B1     "\033[38;5;110m"
 #define XC_B2    "\033[38;5;75m"
 #define XC_B3    "\033[38;5;39m"
 #define XC_B4    "\033[38;5;27m"
 #define XC_B5    "\033[38;5;21m"
 #define XC_B6    "\033[38;5;20m"
 #define XC_B7    "\033[38;5;19m"
 #define XC_B8    "\033[38;5;18m"
 #define XC_B9    "\033[38;5;17m"
                     /*Cyans*/
 #define XC_C1    "\033[38;5;159m"
 #define XC_C2    "\033[38;5;116m"
 #define XC_C3    "\033[38;5;86m"
 #define XC_C4    "\033[38;5;45m"
 #define XC_C5    "\033[38;5;51m"
 #define XC_C6    "\033[38;5;87m"
 #define XC_C7    "\033[38;5;37m"
 #define XC_C8    "\033[38;5;50m"
 #define XC_C9    "\033[38;5;42m"	
                     /*Magenta*/
 #define XC_M1    "\033[38;5;219m"
 #define XC_M2    "\033[38;5;213m"
 #define XC_M3    "\033[38;5;207m"
 #define XC_M4    "\033[38;5;206m"
 #define XC_M5    "\033[38;5;201m"
 #define XC_M6    "\033[38;5;164m"
 #define XC_M7    "\033[38;5;127m"
 #define XC_M8    "\033[38;5;89m"
 #define XC_M9    "\033[38;5;53m"
                      /*Oranges*/
 #define XC_O1    "\033[38;5;221m"
 #define XC_O2    "\033[38;5;220m"
 #define XC_O3    "\033[38;5;178m"
 #define XC_O4    "\033[38;5;214m"
 #define XC_O5    "\033[38;5;208m"
 #define XC_O6    "\033[38;5;202m"
 #define XC_O7    "\033[38;5;166m"
 #define XC_O8    "\033[38;5;130m"
 #define XC_O9    "\033[38;5;94m"
                     /*Pinks*/
 #define XC_P1    "\033[38;5;224m"
 #define XC_P2    "\033[38;5;181m"
 #define XC_P3    "\033[38;5;199m"
 #define XC_P4    "\033[38;5;162m"
 #define XC_P5    "\033[38;5;161m"
 #define XC_P6    "\033[38;5;204m"
 #define XC_P7    "\033[38;5;203m"
 #define XC_P8    "\033[38;5;210m"
 #define XC_P9    "\033[38;5;217m"
                    /*Reds*/
 #define XC_R1    "\033[38;5;223m"
 #define XC_R2    "\033[38;5;173m"
 #define XC_R3    "\033[38;5;216m"
 #define XC_R4    "\033[38;5;209m"
 #define XC_R5    "\033[38;5;196m"
 #define XC_R6    "\033[38;5;160m"
 #define XC_R7    "\033[38;5;124m"
 #define XC_R8    "\033[38;5;88m"
 #define XC_R9    "\033[38;5;52m"
                    /*Yellows*/
 #define XC_Y1    "\033[38;5;148m"
 #define XC_Y2    "\033[38;5;149m"
 #define XC_Y3    "\033[38;5;191m"
 #define XC_Y4    "\033[38;5;227m"
 #define XC_Y5    "\033[38;5;226m"
 #define XC_Y6    "\033[38;5;184m"
 #define XC_Y7    "\033[38;5;142m"
 #define XC_Y8    "\033[38;5;100m"
 #define XC_Y9    "\033[38;5;58m"
...
//	char * skspell[MAX_CLASS][MAX_RELG_RANK];
	bool valid;
	char * chan_name;
	char * sac_msg;
	char * pmt_msg;
...
#define CLAN_IMMORTAL		E /* immortal only clan */
...
#define CON_GET_ETRAIT			18
#define CON_GET_HTRAIT			19
...
#define cc			268435456    
#define dd			536870912
#define ee			1073741824U
#define ff			2147483648U
#define gg			4294564296U
#define hh			8589128592U
...
// bits for ch->pcdata->stats[AFF]
	#define VAMP_FANGS			1
	#define VAMP_CLAWS			2
	#define VAMP_REVEAL			3
...
//	#define FORM_MIST			4
	...
	#define GEN        			0	/* vampgen */
	#define AFF					1	/* vampaff */
	#define CURRENT				2	/* vamppass */
...
#define AFF_SLOW		(dd)
#define AFF_FORCE_SHIELD	(ee)
#define AFF_STATIC_SHIELD	(ff)
#define AFF_FLAME_SHIELD	(gg)
...
#define ITEM_LODGED_BODY	(R)
#define ITEM_WEAR_SHOULDER	(S)
...
#define WEAPON_MACE		5
#define WEAPON_AXE		6
#define WEAPON_FLAIL		7
...
#define HEIGHT_AVERAGE (B)
#define HEIGHT_TALL (C)
#define HEIGHT_GIANT (D)
...
#define ACTION_PRINT	A 
#define ACTION_WAIT		B
#define ACTION_ACT		C
#define ACTION_FUNCTION	D
...
struct	char_data
{
    ...
    long		act;
    long		comm;  
	long		lang;/* RT added to pad the vector */
 ...
 * Character macros.
 */
#define IS_VAMPAFF(ch, sn)	( IS_SET( (ch)->pcdata->stats[AFF], (sn) ) )
#define IS_VAMP(ch)			(ch->race == race_lookup("vampire"))
...
#define HAS_ORGANIZATION(ch)                ( (ch)->pcdata->organization )
#define IS_SAME_ORGANIZATION(ch, vct)       ( (ch)->pcdata->organization == (vct)->pcdata->organization )
...
#define PERS(ch, looker)	( can_see( looker, (ch) ) ?		\
				( (IS_NPC(ch) || !is_known(looker,(ch)) ? (ch)->short_descr	\
				: (ch)->name )) : "someone" )
 ...
 * Global constants.
 */
extern	const	struct	str_app_type	str_app		[35];
extern	const	struct	int_app_type	int_app		[35];
extern	const	struct	wis_app_type	wis_app		[35];
extern	const	struct	dex_app_type	dex_app		[35];
extern	const	struct	con_app_type	con_app		[35];
extern const struct eye_type etrait_table []; /* Coded by Shinji - mudnet.net
7000 */
extern const struct hair_type htrait_table []; /* Coded by Shinji - mudnet.net
7000 */
...
#define ORG_DIR			"../data/organizations/"
#define ORG_LIST		"../data/organizations/org.lst"
#define TIME_FILE		"time.txt"
#define DATA_DIR		"../data/"
#define CLASS_DIR		"../data/class/"  /*Class files*/
#define CLAN_DIR		"../data/clan/"
...
bool is_known	args(( CHAR_DATA *ch, CHAR_DATA *victim));
void known_add	args ((CHAR_DATA *ch, char *name));
...
void crushcaps  args( ( char *string));
...
int height_lookup args((const char *cheight));
int weight_lookup args((const char *cweight));
...
char *  clan_bit_name  args( ( int guild_flags ) );
bool    is_clan         args( (CHAR_DATA *ch) );
bool    is_same_clan    args( (CHAR_DATA *ch, CHAR_DATA *victim) );
int 	clan_lookup	args( (const char *name) );
void 	do_clanadd	args( (CHAR_DATA *ch, char *argument ) );
void	do_clanpmote	args( (CHAR_DATA *ch, char *argument) );
char 	*player_rank	args( (CHAR_DATA *ch) );
char	*player_clan	args( (CHAR_DATA *ch) );
bool	can_clan	args( (CHAR_DATA *ch) );
bool    can_declan     args( (CHAR_DATA *ch) );
...
void	olc_autosave args( ( void ) );
void	save_time	args( ( void ) );
...
/* send.c */
void	send_to_one		args( ( CHAR_DATA *, char *, ... ) );
void	send_to_one2	args( ( CHAR_DATA *, char *, ... ) );
void	send_to_except	args( ( CHAR_DATA *, char *, ... ) );
void	send_to_all		args( ( char *, ... ) );
...
int	item_lookup	args( ( const char *name) );
int	liq_lookup	args( ( const char *name) );
int ore_lookup args( ( const char *name ) );
int smith_item_lookup args( ( const char *name) );
