...
{
	{ "tiny", {FALSE, TRUE, FALSE, TRUE,TRUE, FALSE}},
	{ "short", {FALSE, TRUE, TRUE, TRUE, TRUE, FALSE}},
//	{ "average"},
	{ "tall", {FALSE, TRUE, TRUE, TRUE, FALSE, TRUE}},
	{ "giant",{FALSE, FALSE, FALSE, TRUE, FALSE, TRUE}},
	{ NULL, {FALSE,FALSE, FALSE, FALSE, FALSE, FALSE}}
};

const struct weight_type weight_table [] =
{
	{ "slender", FALSE, TRUE, FALSE, FALSE},
	{ "slim", TRUE, TRUE, TRUE, FALSE},
	{ "petite", FALSE, TRUE, FALSE, FALSE},
	{ "muscled", TRUE, TRUE, TRUE, FALSE},
//	{ "average" },
	{ "stocky", TRUE, FALSE, TRUE, FALSE},
	{ "heavy", TRUE, TRUE, TRUE, FALSE},
...
*/
	...
	"vampire",		TRUE,
	0,		0, 0,
	0,		RES_DISEASE|RES_COLD, VULN_FIRE|VULN_HOLY,
	A|H|M|V,	A|B|C|D|E|F|G|H|I|J|K, FALSE 
	},
...
*/
    ...
    {
	"vampire",	"Vamp ",	8,	{ 125, 125, 125, 125 },
	{ "berserk" },
	{ 16, 16, 16, 16, 16 },	{ 20, 20, 20, 20, 20 }, SIZE_MEDIUM
    },
...
const	struct	int_app_type	int_app		[35]		=
{
    {  3 },	/*  0 */
    {  5 },	/*  1 */
    {  7 },
...
const	struct	wis_app_type	wis_app		[35]		=
{
    { 0 },	/*  0 */
    { 0 },	/*  1 */
    { 0 },
...
const	struct	dex_app_type	dex_app		[35]		=
{
    {   60 },   /* 0 */
    {   50 },   /* 1 */
    {   50 },
...
const	struct	con_app_type	con_app		[35]		=
{
    { -4, 20 },   /*  0 */
    { -3, 25 },   /*  1 */
    { -2, 30 },
 ...
 */
    ...
    {
	"acid blast",		{ 28, 53, 35, 32, 35 }, 	{ 1,  1,  2,  2, 1},
...

   {
	...
	{ "resurrect",		{ 93, 20, 93, 93 },		{ 1, 10, 1, 1 },
...
const   struct  group_type      group_table     [MAX_GROUP]     =
{
	...
	{ "lore", "beguiling", "combat", "detection", "enhancement", "illusion",
	  "maladictions", "protective", "transportation", "weather", "shielding" }
    },
	...
	{ "mace", "sword", "backstab", "circle", "disarm", "dodge", "second attack",
	  "trip", "hide", "peek", "pick lock", "sneak", "forging" }
    },

    {
	"warrior default",	{ -1, -1, -1, 40, -1 },
	{ "weaponsmaster", "shield block", "bash", "disarm", "enhanced damage", 
	  "parry", "rescue", "third attack", "forging" }
    },

    {
	"weaponsmaster",	{ 40, 40, 40, 20, -1 },
	...
	{
		"shielding",	{ 4, 4, 8, 9, -1 },
		{ "flame shield", "static shield", "force shield"}
	},

    {
	"transportation",	{ 4, 4, 8, 9, -1 },
